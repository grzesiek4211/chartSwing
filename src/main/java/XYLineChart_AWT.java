...
public class XYLineChart_AWT extends JFrame {
    ...
    public static ChartPanel chartPanelLine;
    ...
    public XYLineChart_AWT(int draw, String para) {
        super("");
        ...
        chartPanelLine = new ChartPanel( xylineChart );
        chartPanelLine.setPreferredSize( new Dimension( 500 , 2000 ) );
        chartPanelLine.getChart().getXYPlot().getDomainAxis().setInverted(true); // odwrocenie osi OX
